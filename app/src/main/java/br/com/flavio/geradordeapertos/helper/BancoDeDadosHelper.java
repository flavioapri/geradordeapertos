...
public class BancoDeDadosHelper extends SQLiteOpenHelper {
    ...
    public static final String NOME_BANCO = "geradordeapertos";
    ...
    private static final String CRIAR_TABELA_PROCESSO =
            "CREATE TABLE " + TABELA_PROCESSO + " (" + ID + " INTEGER PRIMARY KEY, " + NOME + " TEXT NOT NULL, " + ID_APERTADEIRA + " " +
                    "INTEGER" +
                    " NOT NULL, " + CICLOS + " " +
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        try {
            ...
            InputStream inputStream = assetManager.open("dbdata.txt");
